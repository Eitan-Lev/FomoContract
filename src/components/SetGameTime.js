...
class SetGameTime extends React.Component {
  state = { stackId: null, value: null ,isHidden: false};
  ...
  //  const contract = drizzle.contracts.FomoNoCallback;
    ...
    const stackId = contract.methods.changeGameTime.cacheSend(value, {
      ...
      from: drizzleState.accounts[accounts.getAccount("Creator")],// TODO
    });
  ...
  checkCreator() {
    return ((this.props.account) == accounts.getAccount("Creator"))
  };
